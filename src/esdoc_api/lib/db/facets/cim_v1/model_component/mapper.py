"""
.. module:: esdoc_api.lib.db.facets.cim_v1.model_component.mapper.py
...
from esdoc_api.lib.db.facets.cim_v1.model_component.parser import parse
from esdoc_api.lib.db.facets.cim_v1.model_component.reducer import reduce
...
def _get_facet(type_id, key, value, value_for_display=None, key_for_sort=None):
    ...
    """
    return get_facet(_facet_types[type_id], 
                     key,
                     value,
...
def _set_facet_relation(type, from_facet, to_facet):
    ...
    """
    set_facet_relation(_facet_relation_types[type],
                       from_facet,
                       to_facet)
...
def _get_model_facet_set(m):
    ...
    """
    return _get_facet(ID_OF_FACET_MODEL,
...
def _set_component_facet_relations(mf, cf, pcf):
    ...
    :type mf: esdoc_api.models.entities.entity.Facet

    :param cf: A component facet.
    :type cf: esdoc_api.models.entities.entity.Facet

    :param cf: A parent component facet.
    :type cf: esdoc_api.models.entities.entity.Facet

    """
    _set_facet_relation(ID_OF_FACET_RELATION_FROM_MODEL_2_COMPONENT, mf, cf)
    if pcf is not None:
        _set_facet_relation(ID_OF_FACET_RELATION_FROM_COMPONENT_2_COMPONENT, pcf, cf)
...
def _get_property_facet_set(p):
    ...
    """
    return _get_facet(ID_OF_FACET_PROPERTY,
           ...
           _get_facet(ID_OF_FACET_PROPERTY,
...
def _set_property_facet_relations(mf, cf, pf, ppf):
    ...
    :type pf: esdoc_api.models.entities.entity.Facet

    :param ppf: A parent component property facet.
    :type ppf: esdoc_api.models.entities.entity.Facet

    """
    _set_facet_relation(ID_OF_FACET_RELATION_FROM_MODEL_2_PROPERTY, mf, pf)
    _set_facet_relation(ID_OF_FACET_RELATION_FROM_COMPONENT_2_PROPERTY, cf, pf)
    if ppf is not None:
        _set_facet_relation(ID_OF_FACET_RELATION_FROM_PROPERTY_2_PROPERTY, ppf, pf)
...
def _get_value_facet_set(v):
    ...
    """
    return _get_facet(ID_OF_FACET_VALUE,
...
def _set_value_facet_relations(mf, pf, vf):
    ...
    :type vf: esdoc_api.models.entities.entity.Facet

    """
    _set_facet_relation(ID_OF_FACET_RELATION_FROM_PROPERTY_2_VALUE, pf, vf)
    _set_facet_relation(ID_OF_FACET_RELATION_FROM_MODEL_2_VALUE, mf, vf)
