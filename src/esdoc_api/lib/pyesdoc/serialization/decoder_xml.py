"""
.. module:: esdoc_api.lib.pyesdoc.serialization.decoder_xml.py
...
def _set_type_info(ctx):
    ...
    if ctx.ontology_name in type_info and \
       ...
       ctx.type in type_info[ctx.ontology_name][ctx.ontology_version]:
        ...
        print "WARNING :: esdoc_api.lib.pyesdoc type information is underivable", ctx.ontology_name, ctx.ontology_version, ctx.type
