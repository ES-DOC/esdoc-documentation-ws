"""
.. module:: cim.v1_5.decoding.decoder_for_quality_package.py
...
.. note:: Code generated using esdoc_mp @ 2013-04-17 17:20:28.623388.
...
def decode_cim_quality(xml, nsmap):
    ...
    :rtype: cim.v1_5.types.{package-name}.CimQuality
...
def decode_evaluation(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.Evaluation
...
def decode_measure(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.Measure
...
def decode_report(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.Report
