"""
.. module:: cim.v1_5.decoding.decoder_for_grids_package.py
...
.. note:: Code generated using esdoc_mp @ 2013-04-17 17:20:28.621872.
...
def decode_coordinate_list(xml, nsmap):
    ...
    :rtype: cim.v1_5.types.{package-name}.CoordinateList
...
def decode_grid_extent(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridExtent
...
def decode_grid_mosaic(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridMosaic
...
def decode_grid_property(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridProperty
...
def decode_grid_spec(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridSpec
...
def decode_grid_tile(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridTile
...
def decode_grid_tile_resolution_type(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.GridTileResolutionType
...
def decode_vertical_coordinate_list(xml, nsmap):
    ...
    :type nsmap: dict
    :returns: A decoded type instance.
    :rtype: cim.v1_5.types.{package-name}.VerticalCoordinateList
