...
__all__ = [
    ...
    'validate_cim_document_relationship',
    'validate_cim_document_relationship_target',
    'validate_cim_genealogy',
    'validate_cim_info',
...
supported = (
    ...
    shared.validate_cim_document_relationship,
    shared.validate_cim_document_relationship_target,
    shared.validate_cim_genealogy,
