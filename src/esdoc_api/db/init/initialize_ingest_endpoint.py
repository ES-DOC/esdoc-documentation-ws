"""
.. module:: initialize_ingest_endpoint.py
   :platform: Unix
   :synopsis: Initializes collection of supported ingestion endpoints.
...
def execute():
    """Initializes collection of supported ingest endpoints.
