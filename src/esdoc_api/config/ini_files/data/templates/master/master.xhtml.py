...
_magic_number = 6
_modified_time = 1376661826.4651971
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 6
    ns = runtime.TemplateNamespace('__anon_0x105370050', context._clean_inheritance_tokens(), templateuri=u'/master/master.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x105370050')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x105370050')._populate(_import_ns, [u'*'])
        ...
        # SOURCE LINE 65
        __M_writer(escape(h.stylesheet_link('/css/std-html-all.css')))
        __M_writer(u'\n        <!-- JQuery -->\n        ')
        # SOURCE LINE 67
        ...
        __M_writer(u'\n        <!-- Metafor -->\n        ')
        # SOURCE LINE 71
        __M_writer(escape(h.stylesheet_link('/css/mf-site-all.css')))
        __M_writer(u'\n        <!--*************************************************-->\n        <!-- JS Declaration                                  -->\n        <!--*************************************************-->\n        <!-- JQuery -->\n        ')
        # SOURCE LINE 76
        ...
        __M_writer(u'\n        <!-- Metafor -->\n        ')
        # SOURCE LINE 87
        __M_writer(escape(h.javascript_link('/js/lib/mf-lib.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 88
        __M_writer(escape(h.javascript_link('/js/lib/core/mf-lib-core-AjaxHelper.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 89
        __M_writer(escape(h.javascript_link('/js/lib/core/mf-lib-core-DataLoader.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 90
        __M_writer(escape(h.javascript_link('/js/lib/core/mf-lib-core-Repository.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 91
        __M_writer(escape(h.javascript_link('/js/lib/core/mf-lib-core-EntityManager.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 92
        __M_writer(escape(h.javascript_link('/js/lib/core/mf-lib-core-SearchEngine.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 93
        __M_writer(escape(h.javascript_link('/js/lib/ui/mf-lib-ui-Grid.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 94
        __M_writer(escape(h.javascript_link('/js/lib/ui/mf-lib-ui-Utils.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 95
        __M_writer(escape(h.javascript_link('/js/lib/ui/mf-lib-ui-Feedback.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 96
        __M_writer(escape(h.javascript_link('/js/lib/ui/mf-lib-ui-Toolbar.js')))
        __M_writer(u'\n        ')
        # SOURCE LINE 97
        __M_writer(escape(h.javascript_link('/js/lib/ui/mf-lib-ui-Validator.js')))
