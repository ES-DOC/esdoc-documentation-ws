...
def test_get_document_sub_documents():
    # Tests retrieiving a list of document child documents.
    sub_document = tu.get_test_model(models.DocumentSubDocument)
    document = dao.get_by_id(models.Document, sub_document.Document_ID)
    tu.assert_object(document, models.Document)
    sub_documents = dao.get_document_sub_documents(sub_document.Document_ID)
...
def test_delete_document_representations():
    # Tests deleting all document representations.
    pass
...
def test_delete_document_sub_documents():
    # Tests deleting a list of DocumentSubDocument instances filtered by their Document ID.
    pass


def test_delete_document_external_ids():
    # Tests deleting a list of DocumentExternalID instances filtered by their Document ID.
    pass
